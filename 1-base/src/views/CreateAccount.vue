<template>
  <div class="createaccount">
    <div class="content center">
      ...
      <form class="createaccount-form" @submit.prevent="submitLogin">
        ...
        <div class="actions">
          <button type="submit" class="center" @click="createAccount">
            Criar conta
          </button>
        </div>
        ...
        <div class="actions">
          <button type="navigate" class="center" @click="returnToLogin">
            Voltar
          </button>
        </div>
      </form>
